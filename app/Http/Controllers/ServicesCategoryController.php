...
class ServicesCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('admin.services-category.view', compact('categories'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.services-category.show', compact('category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['order'] = ServicesCategory::count() + 1;
