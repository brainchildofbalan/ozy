                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($categories as $category)
                            <tr>
                                <td class="fw-bold text-black">{{ $category->title }}</td>

                                <td class="fw-medium text-black">{{ $category->url }}</td>
                                ...
                                <td class="fw-medium">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('menus.show', $category->id) }}"">

                                                <span class="btn btn-secondary">View</span></a>


                                            <a class="dropdown-item" href="{{ route('menus.edit', $category->id) }}"">
