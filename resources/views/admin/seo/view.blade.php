...
@section('content')
    <div class="flex-grow-1 container-p-x container-p-y">
        <div class="card mb-3 flex-row justify-content-between align-items-center p-3">
            <h5 class="card-header p-0"Seo manager</h5>
                <a href="{{ route('seo.create') }}" class="btn btn-primary">Create new seo</a>
        </div>
                                ...
                                <td class="fw-medium">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('seo.edit', $category->id) }}"">
                                            ...
                                            <form class="dropdown-item" method="post"
                                                action="{{ route('seo.destroy', $category->id) }}"
