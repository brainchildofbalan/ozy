                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <input class="form-range pe-2" type="range" min="0" max="5" step="0.5"
                                    id="star-rating-range" name="star_rating" value="{{ old('star_rating', intval($products->star_rating)) }}" oninput="this.nextElementSibling.value = this.value">
                                <output class="" for="star-rating-range" id="star-rating-output">{{ old('star_rating', intval($products->star_rating)) }}</output>
                                @error('star_rating')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control @error('sold_out_items') is-invalid @enderror" type="text"
                                    ...
                                    value="{{ old('sold_out_items', $products->sold_out_items) }}">
