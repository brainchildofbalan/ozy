            ...
            <tr>
                <td style="width: 520px; padding-top: 37px; padding-bottom: 0px" align="center">
                    ...
                    ">
                                    ...
                                    We are pleased to confirm the placement of your recent order with
                                    Ozyarabia.<br /><br />

                                    Attached to this email, you will find a PDF invoice detailing the order and
                                    providing payment instructions. Please review the invoice carefully and follow the
                                    payment instructions to complete your order.<br /><br />

                                    <ul>
                                        <li>Payment Method: Card</li>
                                        <li>Amount Due: KWD1200</li>
                                        <li>Due Date: 11/11/2024</li>
